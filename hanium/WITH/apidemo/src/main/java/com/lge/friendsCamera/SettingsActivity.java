...
public class SettingsActivity extends AppCompatActivity implements OnClickListener {
    ...
    private CheckBox get_networkType = null;
    private CheckBox get_signalLevel = null;
    private CheckBox get_wifiLevel = null;
    private CheckBox get_networkOperator = null;
    private CheckBox get_simCard = null;
    private CheckBox get_dataUsage = null;
    private CheckBox get_mobileDataOnOffStatus = null;
    ...
    private EditText set_enableMobileData = null;
    ...
    private void setupViews() {
        ...
        get_networkType = (CheckBox) findViewById(R.id.get_networkType);
        get_signalLevel = (CheckBox) findViewById(R.id.get_signalLevel);
        get_wifiLevel = (CheckBox) findViewById(R.id.get_wifiLevel);
        get_networkOperator = (CheckBox) findViewById(R.id.get_networkOperator);
        get_simCard = (CheckBox) findViewById(R.id.get_simCard);
        get_dataUsage = (CheckBox) findViewById(R.id.get_dataUsage);
        get_mobileDataOnOffStatus = (CheckBox) findViewById(R.id.get_mobileDataOnOffStatus);
        ...
        set_enableMobileData = (EditText) findViewById(R.id.set_enableMobileData);
        ...
        get_networkType.setOnClickListener(this);
        get_signalLevel.setOnClickListener(this);
        get_wifiLevel.setOnClickListener(this);
        get_networkOperator.setOnClickListener(this);
        get_simCard.setOnClickListener(this);
        get_dataUsage.setOnClickListener(this);
        get_mobileDataOnOffStatus.setOnClickListener(this);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.get_freeCapacity:
                ...
                break;
            case R.id.get_networkType:
                makeGetList(get_networkType);
                break;
            case R.id.get_signalLevel:
                makeGetList(get_signalLevel);
                break;
            case R.id.get_wifiLevel:
                makeGetList(get_wifiLevel);
                break;
            case R.id.get_networkOperator:
                makeGetList(get_networkOperator);
                break;
            case R.id.get_simCard:
                makeGetList(get_simCard);
                break;
            case R.id.get_dataUsage:
                makeGetList(get_dataUsage);
                break;
            case R.id.get_mobileDataOnOffStatus:
                makeGetList(get_mobileDataOnOffStatus);
                break;
    ...
    private void setSettings() {
        ...
        String enableMobileData = set_enableMobileData.getText().toString();
        ...
        try {
            ...
            if(enableMobileData.getBytes().length >0){
                setParam.put(set_enableMobileData.getTag().toString(), Utils.parseInt(enableMobileData));
            }
    ...
    private void clearGetList() {
        ...
        get_networkType.setChecked(false);
        get_signalLevel.setChecked(false);
        get_wifiLevel.setChecked(false);
        get_networkOperator.setChecked(false);
        get_simCard.setChecked(false);
        get_dataUsage.setChecked(false);
        get_mobileDataOnOffStatus.setChecked(false);
        getArrayList.clear();
    }
